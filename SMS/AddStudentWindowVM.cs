...
namespace SMS
{
	...
	public partial class AddStudentWindowVM: ObservableObject,ICloseWindows
	{
		...
		void CreateStudent()
		{
			...
			using (DataContext context = new DataContext())
			{
				...
				gender = 'F';
				image = "6.png";
				dateOfBirth = "5/12/2069";
				gPA = 3.2;
				email = "monka@gmail.com";

				if (firstName != null && lastName != null && image != null && dateOfBirth != null && gender != null && email != null)
				{
					context.Students.Add(new Student(firstName, lastName, gender, image, dateOfBirth, gPA, email));
					context.SaveChanges();
				}
				else
				{
					MessageBox.Show("Invalid details inserted !");
				}
